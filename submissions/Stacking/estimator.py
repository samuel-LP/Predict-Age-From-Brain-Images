...
def get_estimator():
    estimator = make_pipeline(VBMFeatureExtractor(),
                              StandardScaler(),
                              GradientBoostingRegressor(learning_rate = 0.003,
                                                        max_depth = 5,
                                                        n_estimators= 1500))
...
estimator = make_pipeline(
    ...
    StackingRegressor(
        estimators=[
            ('gradient_boosting', GradientBoostingRegressor(learning_rate=0.01, max_depth=3, n_estimators=1000)),
            ('random_forest', RandomForestRegressor(n_estimators=1000, max_depth=15))
        ],
        final_estimator=GradientBoostingRegressor(learning_rate=0.01, max_depth=10, n_estimators=600))
    )